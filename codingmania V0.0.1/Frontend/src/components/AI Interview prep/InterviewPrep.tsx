...
function App() {
  ...
  const renderCurrentState = () => {
    switch (currentState) {
      case 'home':
        return (
          <div className="min-h-screen bg-[#050505] flex items-center justify-center px-4 pt-28 pb-8">
            <div className="text-center space-y-5 max-w-4xl">
              <div className="relative">
                ...
                <div className="relative">
                  <Brain className="w-16 h-16 mx-auto text-red-400 mb-3" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5 hover:bg-gray-800/70 transition-all duration-300">
                  <Clock className="w-10 h-10 text-green-400 mb-3 mx-auto" />
                  <h3 className="text-lg font-semibold text-white mb-1">Timed Practice</h3>
                  <p className="text-gray-400 text-sm">Experience real interview conditions with time constraints</p>
                </div>

                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5 hover:bg-gray-800/70 transition-all duration-300">
                  <Trophy className="w-10 h-10 text-yellow-400 mb-3 mx-auto" />
                  <h3 className="text-lg font-semibold text-white mb-1">Multiple Levels</h3>
                  <p className="text-gray-400 text-sm">Choose from beginner, intermediate, or experienced levels</p>
                </div>

                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5 hover:bg-gray-800/70 transition-all duration-300">
                  <BarChart3 className="w-10 h-10 text-red-400 mb-3 mx-auto" />
                  <h3 className="text-lg font-semibold text-white mb-1">Performance Tracking</h3>
                  <p className="text-gray-400 text-sm">Monitor your progress with detailed analytics</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white font-semibold py-3 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-[0_0_20px_rgba(220,38,38,0.3)] hover:shadow-xl flex items-center justify-center space-x-3 mx-auto"
                >
