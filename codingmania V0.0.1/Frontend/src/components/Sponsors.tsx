          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {sponsors.map((sponsor, index) => (
              <motion.a
                ...
                className="group glass-panel rounded-2xl p-6 flex flex-col items-center justify-center border-t border-l border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.5)] transform hover:scale-[1.02] hover:shadow-[0_15px_30px_rgba(220,38,38,0.2)] transition-all duration-300 cursor-pointer relative overflow-hidden"
              >
                ...
                <div className="text-center relative">
                  <h3 className="text-base font-semibold text-white mb-1 group-hover:text-shadow-glow transition-all">
                    {sponsor.name}
                  </h3>
                  <span className="flex items-center gap-1 text-xs text-gray-500 group-hover:text-gray-400">
