...
const Certifications: React.FC<CertificationsProps> = ({ isOpen, onClose }) => {
  ...
  const getStatusColor = (status: string) => {
    switch(status) {
      ...
      case "in-progress": return "bg-red-500/15 text-red-300";
          ...
          {sortedCertificates.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {sortedCertificates.map(cert => (
                <div key={cert.id} className="bg-white/5 border border-white/10 rounded-xl p-6 hover:shadow-lg transition-shadow duration-200">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:bg-white/10 disabled:text-gray-500 disabled:cursor-not-allowed transition-colors duration-200"
                    >
                    ...
                    <button
                      ...
                      disabled={cert.status === 'in-progress'}
                      className="flex items-center justify-center gap-2 px-3 py-2 border border-white/10 text-gray-300 rounded-lg hover:bg-white/5 disabled:bg-white/5 disabled:text-gray-500 disabled:cursor-not-allowed transition-colors duration-200"
                    >
