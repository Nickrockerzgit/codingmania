        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-white/10 space-y-2">
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-white/5 hover:text-white rounded-xl transition-colors"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-red-500/10 hover:text-red-300 rounded-xl transition-colors"
            >
