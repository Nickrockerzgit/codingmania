...
const AlumniProfile = ({ isEditing, setIsEditing }: AlumniProfileProps) => {
  ...
  const panelClassName =
    "rounded-3xl border border-white/10 bg-white/5 p-5 shadow-[0_18px_45px_-30px_rgba(15,23,42,0.45)] backdrop-blur-sm";
  const labelClassName =
    "mb-2 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.22em] text-gray-300";
      ...
      <div className="border-b border-white/10 bg-white/5 px-6 py-5 text-white md:px-8">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          {!isEditing && (
            <button
              onClick={handleEdit}
              className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/10 bg-red-600 px-4 py-3 text-sm font-semibold text-white transition hover:bg-red-700"
            >
            ...
            <div className="mb-6 grid gap-4 lg:grid-cols-[1.4fr_0.9fr]">
              <div className="relative overflow-hidden rounded-[28px] bg-white/5 backdrop-blur-sm border border-white/10 p-6 text-white shadow-[0_20px_50px_-35px_rgba(15,23,42,0.85)]">
                ...
                <div className="relative flex flex-col gap-5 md:flex-row md:items-center">
                  <div className="relative">
                    ...
                    {isEditing && (
                      <label className="absolute -bottom-2 -right-2 flex cursor-pointer items-center justify-center rounded-2xl border border-white/10 bg-red-600 p-2 text-white shadow-lg backdrop-blur transition hover:bg-red-700">
                        {isUploading ? (
                  ...
                  <div className="relative flex-1">
                    <div className="mb-4 flex flex-wrap items-center gap-2">
                      <span className="rounded-full border border-red-500/30 bg-red-500/10 px-3 py-1 text-xs font-medium uppercase tracking-[0.24em] text-red-400">
                        {profile.role || "Alumni"}
                      </span>
                      {profile.branch && (
              ...
              <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-1">
                ...
                <div className={panelClassName}>
                  <p className="text-xs font-semibold uppercase tracking-[0.22em] text-gray-300">
                    Contact
                  </p>
